                        ...
                        <div class="container published-recuitment-content">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-12 recuitment-inner mb-5">
                                    ...
                                    <h4 class="mb-3">Danh sách ứng tuyển</h4>
                                    <hr>
                                    <table id="example" class="table table-striped table-bordered table-hover mt-4">
                                        ...
                                        <tbody>
                                            <c:forEach var="apply" items="${listApply}" varStatus="status">
                                                <tr>
                                                    <th>${status.index + 1}</th>
                                                    <td>${apply.job.title}</td>
                                                    <td>${apply.job.workingForm}</td>
                                                    <td>${apply.timeapply}</td>
                                                    <td class="text-danger fw-bold">${apply.status}</td>
                                                    <td>
                                        ...
                                        <a class="btn btn-primary"
                                            href="#"><i class="fa-solid fa-user-tag"></i> Ứng viên</a> -->
                                                        <a class="btn btn-warning mx-2 "
                                                            href="/job/chitiet/${apply.job.id}"><i
                                                                class="fa-solid fa-pen-nib"></i> xem chi tiết</a>
                                                        <a class="btn btn-danger" href="/ungvien/huynop/${apply.id}"><i
                                                                class="fa-regular fa-trash-can"></i> hủy nộp đơn</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
