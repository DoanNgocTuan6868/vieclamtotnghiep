              ...
              <div class="row">
                <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
                  ...
                  <form:form class="employee-form" method="post" enctype="multipart/form-data"
                    action="/tuyendung/profileUpdate" modelAttribute="userTD">
                          ...
                          <div class="card-body recuitment-body row">
                            ...
                            <div class="col-md-9">
                              <div class="form-group row d-none ">
                                <label class="col-sm-3 col-form-label text-right label">id<span style="color: red"
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Tên tài khoản<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" placeholder="Nhập tên "
                                    path="fullName" />
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Tên công ty<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" placeholder="Nhập tên " path="company" />
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Email<span style="color: red"
                                    class="pl-2">*</span></label>
                                <div class="col-sm-9">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Loại tài khoản<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" readonly="true" path="plan.name" />
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Nơi làm việc<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Trụ sở công ty<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" placeholder="Nhập địa chỉ"
                                    path="companyAdress" />
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" path="descCompany" />
                                </div>
                              </div>

                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Mô tả công ty<span
                                    style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:textarea type="text" row="10" class="form-control"
                                    placeholder="Nhập mô tả công việc" rows="5" path="desclongcpn"></form:textarea>
                                </div>
                              </div>
                            </div>
                ...
                <div class="col-md-4 col-sm-12 col-12">
                  <div class="recuiter-info">
                    ...
                    <div class="clearfix list-rec">
                      <h4>Hồ Quốc Hiếu</h4>
                      <ul>
                        <li><a href="#">Việc làm đã đăng <strong>(0)</strong></a></li>
                        <li><a href="#">Hồ sơ ứng viên <strong>(11450)</strong></a></li>
