                        ...
                        <div class="card recuitment-card">
                          ...
                          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body recuitment-body row">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Loại tài khoản<span style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Trụ sở công ty<span style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:input type="text" class="form-control" placeholder="Nhập địa chỉ" path="companyAdress"/>
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label text-right label">Mô tả công ty<span style="color: red" class="pl-2">*</span></label>
                                <div class="col-sm-9">
                                  <form:textarea type="text" row="10" class="form-control" placeholder="Nhập mô tả công việc" rows="5" path="desclongcpn"></form:textarea>
                                </div>
                              </div>
                              </div>
