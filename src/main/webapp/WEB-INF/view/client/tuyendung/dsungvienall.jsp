                                        ...
                                        <tbody>
                                            ...
                                            href="#"><i class="fa-regular fa-eye"></i> Xem</a> -->
                                                        <a class="btn btn-primary"
                                                            href="/tuyendung/pheduyet/${apply.id}"><i
                                                                class="fa-solid fa-user-tag"></i> Phê duyệt</a>
                                                        <a class="btn btn-success mx-2 " target="_blank"
                                                            href="/filecv/${apply.user.filecv}"><i
                                                                class="fa-solid fa-pen-nib"></i> Xem hồ sơ</a>
                                                        <a class="btn btn-danger"
                                                            href="/tuyendung/loaiungvien/${apply.id}"><i
                                                                class="fa-regular fa-trash-can"></i> Loại ứng viên</a>
