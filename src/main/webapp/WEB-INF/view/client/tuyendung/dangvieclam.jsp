              ...
              <div class="container published-recuitment-content">
                <div class="row">
                  <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
                    <form:form class="recuitment-form" method="post" enctype="multipart/form-data" action="/tuyendung/taobaidang" modelAttribute="jobnew">
                          ...
                          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            ...
                            <!-- end validate -->
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <form:input type="date" class="form-control  ${not empty errorDateline ? 'is-invalid' : ''}" placeholder="Nhập nơi làm việc" path="dateline"/>
                                  ${errorDateline}
                                </div>
                              </div>
                  ...
                  <div class="col-md-4 col-sm-12 col-12">
                    <div class="recuiter-info">
                      ...
                      <div class="clearfix list-rec">
                        <h4>Gói ${user.plan.name}</h4>
                        <ul>
                          <li><a href="#">Số lượt đăng còn lại <strong>(${user.numPost} bài)</strong></a></li>
