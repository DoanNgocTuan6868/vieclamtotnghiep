                                        ...
                                        <a class="btn btn-primary"
                                            href="#"><i class="fa-solid fa-user-tag"></i> Ứng viên</a> -->
                                                        <a class="btn btn-warning mx-2 "
                                                            href="/tuyendung/updateJob/${job.id}"><i
                                                                class="fa-solid fa-pen-nib"></i> Sửa bài</a>
                                                        <a class="btn btn-danger" href="/tuyendung/xoabai/${job.id}"><i
                                                                class="fa-regular fa-trash-can"></i> Xóa bài</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
