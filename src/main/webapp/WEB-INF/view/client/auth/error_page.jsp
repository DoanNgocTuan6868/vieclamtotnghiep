        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    ...
                    <!-- Favicons -->
                    <link href="/adminpl/assets/img/favicon.png" rel="icon">
                    <link href="/adminpl/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
              ...
              * License: https://bootstrapmade.com/license/
              ======================================================== -->
                ...
                <body>
                    ...
                    <main>
                        <div class="container">
                            ...
                            <section
                                ...
                                <h1>Error !</h1>
                                <h2>TBạn ko có quyền truy cập.</h2>
                                <a class="btn" href="/">về lại trang </a>
                                <img src="/adminpl/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
                                <div class="credits">
                    ...
                    <script src="/adminpl/assets/vendor/tinymce/tinymce.min.js"></script>
