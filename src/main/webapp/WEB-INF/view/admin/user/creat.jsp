  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <body>
     ...
     <!-- End Sidebar-->
                        ...
                        <div class="card-body">
                          ...
                          <c:set var="errorFullname">
                            ...
                            <div class="col-md-12">
                              ...
                              <form:input type="text" class="form-control ${not empty errorFullname ? 'is-invalid' : ''}" id="inputName5" path="fullName" />
                                ${errorFullname}
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              ...
                              <form:select id="inputState" class="form-select" path="role.name">
                                ...
                                <form:option value="USER1">TUYENDUNG</form:option>
                                <form:option value="USER2">UNGVIEN</form:option>
                              </form:select>
                            </div>
                            <div class="col-md-6">
      ...
      <!-- ======= Footer ======= -->
      <jsp:include page="../layout/footer.jsp" /><!-- End Footer -->
